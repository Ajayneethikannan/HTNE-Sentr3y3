...
def monitor(refreshTime):
    ...
    if user_id ==  None: # No one in front of the computer --> lock or standby
        ...
        displayText, user, apps, responseStatus = currentUserDetails(user_id)
            ...
            for app in apps:
                for open_app in open_apps:
                    ...
                    if (app['title'].lower() == process_name):
                        ...
                        # if (profanity != False and data['is_underage'] == True): # If age restricted applications used by underage children at home
